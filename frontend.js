...
const mongoUrl = process.env.MONGO_URL || 'mongodb://localhost:27017/Ruthvikdb';
...
app.get('Ruthvikdb//data', (req, res) => {
...
app.post('/Ruthvikdb/data', (req, res) => {
...
app.put('/Ruthvikdb/data/:id', (req, res) => {
...
app.delete('/Ruthvikdb/data/:id', (req, res) => {
  const id = req.params.id;
